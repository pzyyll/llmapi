		...
		<DialogRoot v-model:open="open">
			...
			<DialogPortal>
				...
				<Transition name="content-fade" @enter="contentFadeIn" @leave="contentFadeOut">
					...
					>
						<DialogTitle class="text-base-content text-lg">
							{{ createSuccess ? $t('save_key') : $t('new_key') }}
						</DialogTitle>
						<form @submit.prevent="handleSubmit" v-show="!createSuccess">
							<div class="mt-2 flex flex-col gap-4">
								<DialogDescription class="text-base-content/80 my-1 text-sm">
									{{ $t('create_key_dialog_desc') }}
								</DialogDescription>
								...
								<div class="mt-2 flex justify-end gap-4">
									...
									<button
										class="d-btn d-btn-sm d-btn-primary min-w-20"
										type="submit"
										:disabled="keyCreating"
									>
